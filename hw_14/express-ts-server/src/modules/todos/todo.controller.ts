import { createTodoDto, CreateTodoDto, updateTodoTitleDto } from "./todo.request.dto";
...
export class TodoController {
 ...
 updateTitle = async (
  ...
  try {
    ...
    const { title } = updateTodoTitleDto.parse(req.body);

    const todo = await this.service.updateTodoTitle(
      id,
      title,
      userId
    );
